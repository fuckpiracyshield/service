...
class TicketItemFQDNGetAllByTicketChecksumForProviderService(BaseService):

    """
    Returns the checksum of the FQDN list of a ticket assigned to a provider.
    """

    checksum = None

    ticket_item_fqdn_get_all_by_ticket_for_provider_service = None
    ...
    def execute(self, ticket_id: str, account_id: str) -> list | Exception:
        ...
        response = self.ticket_item_fqdn_get_all_by_ticket_for_provider_service.execute(
            ticket_id = ticket_id,
    ...
    def _prepare_modules(self):
        self.ticket_item_fqdn_get_all_by_ticket_for_provider_service = TicketItemFQDNGetAllByTicketForProviderService()
