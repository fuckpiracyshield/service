...
class SecurityBlacklistExistsByIPAddressService(BaseService):

    """
    Checks if an item has been blacklisted.
    """
    ...
    def execute(self, ip_address: str) -> bool | Exception:
        return self.data_memory.exists_by_ip_address(
